...
export function PermissionsFactory(
    loadPermissions: PermissionsService,
    NgxPermissionsService: NgxPermissionsService
) {
    return this.permissionsService.getPermissions().sub;
}
            ...
            useFactory: (
                ...
                function () {
                    return ds.getPermissions().subscribe((data) => {
                        ...
                        return role.addRoleWithPermissions('ROLE_NAME', data);

                        // return ps.addRolesWithPermissions('ROLE_NAME', ['permissionNameA', 'permissionNameB', 'permissionNameC', ...]);
                    });
                },
